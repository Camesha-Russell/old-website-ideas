    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-background">
        <div className="max-w-[1200px] mx-auto px-6 py-20 md:py-28">
          ...
          <p className="font-serif-display text-lg md:text-xl text-muted-foreground mb-10">
            For the mom who's done buying things that didn't deliver
          </p>

          {/* Content: two text cols + stacked photos */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_1.1fr] gap-x-12 gap-y-8 items-start">
            {/* Col 1 */}

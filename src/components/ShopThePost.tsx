  ...
  return (
    <section className="py-[100px]">
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white border border-border rounded-lg overflow-hidden">
            ...
            <div className="flex gap-4 mb-8">
              {products.map((_, i) => (
                <div key={i} className="cursor-pointer">
                  <div className="placeholder-img w-24 h-24 md:w-28 md:h-28 bg-background border border-border rounded hover:border-foreground transition-colors" />
                </div>
              ))}
            </div>

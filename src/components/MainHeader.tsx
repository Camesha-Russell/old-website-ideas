    ...
    <header className="bg-white border-b border-border">
      <div className="max-w-[1400px] mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex flex-col items-start leading-none">
          <span className="font-display italic text-lg md:text-xl text-muted-foreground font-normal" style={{ fontStyle: 'italic' }}>
            It's
          </span>
          <span className="font-display text-2xl md:text-3xl text-foreground -mt-1 font-medium" style={{ letterSpacing: '0.02em' }}>
            Mom Approved
          </span>
        </Link>
